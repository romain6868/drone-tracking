...
class Detection:
    def __init__(self):
        ...
        focal_length = 2.75   # Focal length [mm]
        sensor_length = 6.45  # Sensor length (x dimension) [mm]
        sensor_height = 3.63  # Sensor length (y dimension) [mm]  
        self.horizontal_field_view = 102 # [°] Angle horizontal du champ de vision de la caméra
        self.vertical_field_view = 67 # [°] Angle vertical du champ de vision de la caméra
        ...
        # Initialisation picamera
        self.camera = Picamera2()
        camera_config = self.camera.create_still_configuration(main={"size": (1920, 1080),"format": "BGR888"}, lores={"size": (640, 480)}, display="lores")
    ...
    def prise_photo(self):
        ...
        # Prise de la photo
        photo = self.camera.capture_array("main")
