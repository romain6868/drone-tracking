...
picam2 = Picamera2()
camera_config = picam2.create_still_configuration(main={"size": (1920, 1080),"format": "BGR888"}, lores={"size": (640, 480)}, display="lores")
...
while True:
    picam2.capture_file("cap.jpg")
    frame = cv2.imread('cap.jpg', cv2.IMREAD_COLOR)
